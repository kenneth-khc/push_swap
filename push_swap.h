...
/*   Updated: 2023/11/21 13:50:57 by kecheong         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef void				(*t_sorter)(t_stack *, t_stack *);
...
void	sort_a(t_stack *a, t_stack *b, t_sections *list);
...
/* Sorting stack B */
void	sort_b(t_stack *a, t_stack *b, t_sections *list);
...
void	shift_stack(char current_stack, t_stack *a, t_stack *b, char dir);
...
void	init_section(char location, int len,
			t_sections *sections);
...
void	check_first_half(t_sections *sections, t_stack *a, t_stack *b,
			int *first_midpoint);
