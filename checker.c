...
/*   Updated: 2023/09/11 22:38:11 by kecheong         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	read_instructions(&list_of_instructions);
	execute_instructions(&list_of_instructions, &a, &b);
...
void	read_instructions(t_instruction *list_of_instructions)
{
	...
	while (1)
	{
		...
		validate_instruction(current->instruction);
